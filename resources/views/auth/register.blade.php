                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control district_area" name="district_id" id="district_id">
                                    </select>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="street_address" class="col-md-4 col-form-label text-md-right">Street
                                    Address</label>
...
@section('scripts')
    ...
    <script>
        $("#division_id").change(function() {
            ...
            var option = "";
            $.ajax({
                url: "http://127.0.0.1:8000/get-districts/" + division,
